...
class DB_oci8_driver extends DB {
	...
	var $_commit = OCOMMIT_ON_SUCCESS;
	...
	function stored_procedure($package, $procedure, $params)
	{
		...
		foreach ($params as $param)
		{
			...
			if (array_key_exists('type', $param) && ($param['type'] == OB_CURSOR))
			{
				$have_cursor = TRUE;
			}
		}
	...
	function trans_commit()
	{
		...
		$this->_commit = OCOMMIT_ON_SUCCESS;
		return $ret;
	}
