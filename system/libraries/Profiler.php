...
class Profiler {
	...
	protected function _compile_queries()
	{
		...
		foreach (get_object_vars($this->CI) as $object)
		{
			if (is_object($object) && is_subclass_of(get_class($object), 'DB') )
			{
				$dbs[] = $object;
			}
		}
		...
		{
			$output  = "\n\n";
			$output .= '<fieldset id="profiler_queries" style="border:1px solid #0000FF;padding:6px 10px 10px 10px;margin:20px 0 20px 0;background-color:#eee">';
			$output .= "\n";
	...
	{
		$output  = "\n\n";
		$output .= '<fieldset id="profiler_controller_info" style="border:1px solid #995300;padding:6px 10px 10px 10px;margin:20px 0 20px 0;background-color:#eee">';
		$output .= "\n";
	...
	{
		$output  = "\n\n";
		$output .= '<fieldset id="profiler_config" style="border:1px solid #000;padding:6px 10px 10px 10px;margin:20px 0 20px 0;background-color:#eee">';
		$output .= "\n";
