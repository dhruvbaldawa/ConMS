	...
	<div class="main-wrap">
		...
		<div class="page clear">
			...
			<div class="main-icons clear">
				<ul class="clear">
				<li><a href="#"><img src="<?php echo base_url(); ?>images/ico_folder_64.png" class="icon" alt="" /><span class="text">Create an Article</span></a></li>
				<li><a href="#"><img src="<?php echo base_url(); ?>images/ico_page_64.png" class="icon" alt="" /><span class="text">New Page</span></a></li>
				<li><a href="#"><img src="<?php echo base_url(); ?>images/ico_picture_64.png" class="icon" alt="" /><span class="text">Add Picture</span></a></li>
				<li><a href="#"><img src="<?php echo base_url(); ?>images/ico_clock_64.png" class="icon" alt="" /><span class="text">Add Event</span></a></li>
				<li><a href="#"><img src="<?php echo base_url(); ?>images/ico_users_64.png" class="icon" alt="" /><span class="text">Users</span></a></li>
				<li><a href="#modal" class="modal-link"><img src="<?php echo base_url(); ?>images/ico_chat_64.png" class="icon" alt="" /><span class="text">Open Modal</span></a></li>
				</ul>
			</div>
			<!-- CONTENT BOXES -->
