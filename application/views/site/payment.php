...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>ICWET 2011 - <?php if (isset($title))
    echo $title; ?></title>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/ie7.css" />
        ...
        <script type="text/javascript">
            ...
            $('.payment_link').live("click",function (){
                $.fancybox.showActivity();
                $.ajax({
                    type:"POST",
                    url:this.rel,
            ...
            $('#add_payment_form').live("submit",function (){
                var data = $(this).serialize();
                $.ajax({
                    type:"POST",
            ...
            <div class="main"> <!-- *** mainpage layout *** -->
                <div class="main-wrap">
                    ...
                    <div class="page clear">
                        <h1>Payments <a href="#"><img src="<?php echo base_url(); ?>images/ico_help_32.png" class="help" alt="" /></a></h1>
                        <div class="main-icons clear">
                            <ul class="clear">
                                <li><a href="#" rel="<?php echo base_url(); ?>payment/view/payment_form" class="payment_link"><img src="<?php echo base_url(); ?>images/ico_page_64.png" class="icon" alt="" /><span class="text">Add Payment Details</span></a></li>
                            </ul>
                        </div>
                                ...
                                <div id="data-table">
                                    <form action="<?php echo base_url(); ?>site/export" method ="post" >
                                        <input type="hidden" name="csv_text" id="csv_text">
                                            <input type="submit" value="Export Table" onclick="getCSVData()"  />
                                    </form>
                                                        ...
                                                        <td>
                                                            ...
                                                            foreach ($arow['authors'] as $author) {
                                                                if (isset($author['id'])) {
                                                                    ...
                                                                    ?> <a href="#" id="author" rel="<?php echo $author['id']; ?>"><?php echo $author['name'];
                                                        if (!$started) {
                                                            $started = true;
                                                        } ?></a><br /><?php
                                                    } else {
